...
class Monstros(pygame.sprite.Sprite): 
    ...
    def colisao(self, direcao):
        for sprite in self.colisao_sprites:
            if sprite == self:  # evita checar contra si mesmo
                continue
...
class Galega(Monstros):
    def __init__(self, pos, *groups, alvo, colisao_sprites):
        super().__init__(pos, *groups, alvo = alvo, velocidade = 5, vida = 2, nome = 'galega', colisao_sprites=colisao_sprites)

class Perna(Monstros):
    def __init__(self, pos, *groups, alvo, colisao_sprites):
        super().__init__(pos, *groups, alvo = alvo, velocidade = 7, vida = 2, nome = 'perna', colisao_sprites=colisao_sprites)

class Monstro3(Monstros):
    def __init__(self, pos, *groups, alvo, colisao_sprites):
        super().__init__(pos, *groups, alvo = alvo, velocidade = 4, vida = 2, nome = 'bilisome', colisao_sprites=colisao_sprites)
